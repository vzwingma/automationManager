 ...
 */
@Singleton
public class BundleSupervisionBusinessService extends AbstractAutomationService implements EventHandler {


	private static final Logger LOGGER = LoggerFactory.getLogger( BundleSupervisionBusinessService.class );
	// Message Handler
